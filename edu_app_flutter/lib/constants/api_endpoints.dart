class ApiEndpoints {
  ...
  static const String classroomGetStudentsByClass =
      '/classroom/get_students_by_class/';
  ...
  static const String contactGetScheduledEmails =
      '/contact/get_scheduled_emails/';
  static const String contactDeleteEmailSchedule =
      '/contact/delete_email_schedule/';
  ...
  static const String ocrGetAllStudentData = '/ocr/get_all_student_data/';
  ...
  static const String chatbotAskChatbot = '/chatbot/ask_chatbot/';
}
