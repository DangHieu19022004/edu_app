...
class ChatbotRateLimit(Document):
    ...
    general_short_term_count = IntField(default=0)
    general_short_term_window_start = IntField(default=0)
    result_analysis_short_term_count = IntField(default=0)
    result_analysis_short_term_window_start = IntField(default=0)
